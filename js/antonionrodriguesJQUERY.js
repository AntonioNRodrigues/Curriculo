...
$(document).ready(function(){
    $('.buttonJavaSite, .buttonJSPSite, article:nth-child(2) .buttonCodingbat').hide(1200);
});
 ...
 * o elemento com o id de euroWindow é mostrado graças à funçãqo de show()
 */
$(document).ready(function(){
