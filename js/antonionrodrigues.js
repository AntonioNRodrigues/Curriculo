...
function defineArray() {
    ...
    // colocar o element footer no array
    var aux = document.getElementsByTagName('footer');
    arrayContent2[6] = aux[0];

}

/*Torna o elemento Bloco  não visivel, incluindo o footer*/
